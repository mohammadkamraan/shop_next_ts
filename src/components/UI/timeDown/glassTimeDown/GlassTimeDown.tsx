...
const GlassTime: FC<GlassTimeComponentProps> = ({
  days,
  hours,
  minutes,
  secounds,
  ...
  return (
    <div className='flex justify-around'>
      <span className='backdrop-filter block backdrop-blur-[12px] shadow-lg rounded-md w-12 md:w-20 h-10 md:h-16 bg-white dark:bg-slate-900 dark:bg-opacity-30 bg-opacity-40 text-slate-800 dark:text-slate-300'>
        <p className='w-8 mx-auto text-center text-sm md:text-xl'>
          {days} days
        </p>
      </span>
      <span className='backdrop-filter block backdrop-blur-[12px] shadow-lg rounded-md w-12 md:w-20 h-10 md:h-16 bg-white dark:bg-slate-900 dark:bg-opacity-30 bg-opacity-40 text-slate-800 dark:text-slate-300'>
...
const GlassTimeDown: FC<GlassTimeDownComponentProps> = ({ days }) => {
  ...
  return (
    <GlassTime days={day} hours={hour} minutes={minute} secounds={secound} />
  );
};
